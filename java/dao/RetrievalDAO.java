...
public class RetrievalDAO {
    public String checkLostPass(String email) {
        ...
        try {
            ...
            String query = "SELECT password FROM Project353.Accounts WHERE email = ?";
    ...
    public void subscribeMail(String email) {
        ...
        try {
            ...
            String query = "UPDATE Project353.Accounts SET mailingList = 'y' WHERE email = ?";
    ...
    public void unsubscribeMail(String email) {
        ...
        try {
            ...
            String query = "UPDATE Project353.Accounts SET mailingList = 'n' WHERE email = ?";
    ...
    public void sendMailingList(String subject, String body) {
    	...
    	try {
        	...
        	String query = "SELECT * FROM Project353.Accounts WHERE mailingList='y'";
